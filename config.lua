...
Config.deteccoes = {
   ...
   tazeplayer = true,--Ban
   spawnped = true,--Ban
   freezeplayer = true,--Ban
   stopresource = true,--Ban
   spamentitys = true,--Ban < Veh/obj/ped >
   licenseclear = true,--Ban (Maybe AntiBan?)
   inject = true,--Ban
   infinitestamina = false, --Ban
   antiradar = true,--Ban
   termalvision = true,--Ban
   nightvision = true,--Ban
   spectate = true,--Ban
   speed = true,--Ban
   explosion = true,--Ban
   explosiveweapon = true,--Ban
   vehiclemodifier = true,--Ban
   spawnweapon = true,--Ban - delete the weapon
   removeweapon = true,--Ban
   blips = true,--only log < WARNING / Put false if police/ems have blips> 
   antiragdoll = true,--only log
   outofsession = true,--only log
   blacklist = true,--only log
   aimassist = true,--only log
   tp = true,--only log
}
...
Config.logscreenshot = "https://discord.com/api/webhooks/1242387838721327105/0zo81RCQg091enHN2T8e-xtZr1tkIAAgH1eg5ODtAGQgKWU4pjGdP9_T4iYlyowEYHFd" --log when player was screenshoted by command
Config.screenshotperm = "PrintZona" --Permissao Screenshot
...
Config.ac = {
   logban = "https://discord.com/api/webhooks/1242387838721327105/0zo81RCQg091enHN2T8e-xtZr1tkIAAgH1eg5ODtAGQgKWU4pjGdP9_T4iYlyowEYHFd", --log ban player
   logunban = "https://discord.com/api/webhooks/1242387838721327105/0zo81RCQg091enHN2T8e-xtZr1tkIAAgH1eg5ODtAGQgKWU4pjGdP9_T4iYlyowEYHFd", --log unban player
   logsuspect = "https://discord.com/api/webhooks/1242387838721327105/0zo81RCQg091enHN2T8e-xtZr1tkIAAgH1eg5ODtAGQgKWU4pjGdP9_T4iYlyowEYHFd", --log the player that was suspect
   logresources = "https://discord.com/api/webhooks/1242387838721327105/0zo81RCQg091enHN2T8e-xtZr1tkIAAgH1eg5ODtAGQgKWU4pjGdP9_T4iYlyowEYHFd", --log when a resource start
   logwall = "https://discord.com/api/webhooks/1242387838721327105/0zo81RCQg091enHN2T8e-xtZr1tkIAAgH1eg5ODtAGQgKWU4pjGdP9_T4iYlyowEYHFd", --log when an admin start wall
   logplayer = "https://discord.com/api/webhooks/1242387838721327105/0zo81RCQg091enHN2T8e-xtZr1tkIAAgH1eg5ODtAGQgKWU4pjGdP9_T4iYlyowEYHFd", --log when player enter/exit the server
   permissaowall = "WallZona", --Permissao para o wall (Se quiser pode mudar)
   permissaotuning = "", --Permissao de mecanico e administradores que tem o /tuning (Menu da bennys pode ser detectado como hack)
   permissaoadm = "BypassZona", --Permissao da imunidade (Se quiser pode mudar)
   walldistance = 500, -- OneSync Infinity Max Distance
   maxhealth = 400, --Maximo de Vida Do jogador
   AmmoLimit = 250, --Maximo de Muni na arma
   MaxTazeSpam = 2, --Spam Tazer
   MaxClearPedTask = 5, --Clear Ped Task 
   MaxObject = 15, --Maximo de obj que o player pode criar antes de ser banido. (RECOMENDAÇÃO: 15)
   MaxVehicle = 7, --Maximo de veh que o player pode criar antes de ser banido. (RECOMENDAÇÃO: 7)
   MaxPed = 6, --Maximo de peds que o player pode criar antes de ser banido. (RECOMENDAÇÃO: 6)
   blacklistweapon = {
      "WEAPON_PISTOL50",
